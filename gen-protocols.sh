...
wayland-scanner client-header $UNSTABLE_DIR/text-input/text-input-unstable-v3.xml $UNSTABLE_TARGET_DIR/text-input-text-input-unstable-v3.h
wayland-scanner private-code  $UNSTABLE_DIR/text-input/text-input-unstable-v3.xml $UNSTABLE_TARGET_DIR/text-input-text-input-unstable-v3.c
