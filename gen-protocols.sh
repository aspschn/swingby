...
wayland-scanner client-header $STABLE_DIR/viewporter/viewporter.xml $STABLE_TARGET_DIR/viewporter.h
wayland-scanner private-code  $STABLE_DIR/viewporter/viewporter.xml $STABLE_TARGET_DIR/viewporter.c
...
wayland-scanner client-header $STAGING_DIR/fractional-scale/fractional-scale-v1.xml $STAGING_TARGET_DIR/fractional-scale-v1.h
wayland-scanner private-code  $STAGING_DIR/fractional-scale/fractional-scale-v1.xml $STAGING_TARGET_DIR/fractional-scale-v1.c
