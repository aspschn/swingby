...
struct decoration* decoration_new(struct window *window)
{
    ...
    sb_view_set_size_rounding_policy(decoration->view,
    ...
    sb_view_set_size_rounding_policy(decoration->shadow.view,
        SB_ROUNDING_POLICY_CEIL);
...
void decoration_set_size(struct decoration *decoration, sb_size_t size)
{
    ...
    border_geometry.position.x =
        window_decoration_border_offset(decoration->window);
    border_geometry.position.y =
        window_decoration_border_offset(decoration->window);
    ...
    title_bar_geometry.position.x =
        window_decoration_title_bar_offset(decoration->window);
    title_bar_geometry.position.y =
        window_decoration_title_bar_offset(decoration->window);
